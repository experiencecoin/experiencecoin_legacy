...
See `doc/readme-qt.rst` for instructions on building Experiencecoin-Qt, the
...
A litecoind binary is not included in the Experiencecoin-Qt.app bundle. You can ignore
...
on an OS X 10.6 64-bit machine fails. Official release builds of Experiencecoin-Qt are
compiled on an OS X 10.6 32-bit machine to workaround that problem.

Once dependencies are compiled, creating `Experiencecoin-Qt.app` is easy:
