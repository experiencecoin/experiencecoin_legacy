...
*Setup instructions for a gitian build of Experiencecoin using a Debian VM or physical system.*
...
- [Building Experiencecoin](#building-experiencecoin)
...
In [doc/release-process.md](release-process.md) in the experiencecoin repository under 'Fetch and build inputs'.
...
Building Experiencecoin
----------------

To build Experiencecoin (for Linux and/or Windows) just follow the steps under 'perform
gitian builds' in [doc/release-process.md](release-process.md) in the experiencecoin repository.
...
For example:
```bash
URL=https://github.com/langerhans/experiencecoin.git
...
```bash
    gpg --detach-sign ${VERSION}/${SIGNER}/experiencecoin-build.assert
    gpg --detach-sign ${VERSION}-win/${SIGNER}/experiencecoin-build.assert
```
...
[experiencecoin/gitian.sigs](https://github.com/experiencecoin/gitian.sigs/) repository, or
