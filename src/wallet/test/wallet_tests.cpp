...
BOOST_AUTO_TEST_CASE(coin_selection_tests)
{
    ...
    for (int i = 0; i < RUN_TESTS; i++)
    {
        ...
        // test randomness
        {
            ...
            BOOST_CHECK(testWallet.SelectCoinsMinConf(64 * COIN, 1, 6, 0, vCoins, setCoinsRet , nValueRet));
            BOOST_CHECK(testWallet.SelectCoinsMinConf(64 * COIN, 1, 6, 0, vCoins, setCoinsRet2, nValueRet));
...
BOOST_FIXTURE_TEST_CASE(rescan, TestChain100Setup)
{
    ...
    // file.
    {
        ...
        BOOST_CHECK_EQUAL(wallet.GetImmatureBalance(), 64 * COIN);
    }
