...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || gArgs.IsArgSet("-?") || gArgs.IsArgSet("-h") || gArgs.IsArgSet("-help"))
    {
        ...
        std::string strUsage = strprintf(_("%s experiencecoin-tx utility version"), _(PACKAGE_NAME)) + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  experiencecoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded experiencecoin transaction") + "\n" +
              "  experiencecoin-tx [options] -create [commands]   " + _("Create hex-encoded experiencecoin transaction") + "\n" +
              "\n";
