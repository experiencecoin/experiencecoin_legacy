...
QString BitcoinUnits::description(int unit)
{
    switch(unit)
    {
    case MEPC: return QString("Mega-Experiencecoin (1,000,000 EPC)");
    case kEPC: return QString("Kilo-Experiencecoin (1000 EPC)");
    case EPC: return QString("Experiencecoin");
...
qint64 BitcoinUnits::factor(int unit)
{
    switch(unit)
    {
    case MEPC: return Q_INT64_C(100000000000000);
    case kEPC: return Q_INT64_C(100000000000);
    case EPC:  return Q_INT64_C(100000000);
...
qint64 BitcoinUnits::maxAmount(int unit)
{
    switch(unit)
    {
    case MEPC: return Q_INT64_C(900000);
    case kEPC: return Q_INT64_C(900000000);
    case EPC:  return Q_INT64_C(900000000000);    //less than the coin supply until the year 2170
...
int BitcoinUnits::amountDigits(int unit)
{
    switch(unit)
    {
    case MEPC: return 6;  // 900,000 (# digits, without commas)
    case kEPC: return 9;  // 900,000,000
    case EPC:  return 12; // 900,000,000,000
