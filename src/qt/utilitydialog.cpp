    ...
    ui(new Ui::AboutDialog)
{
    ...
    ui->copyrightLabel->setText(tr("Copyright") + QString(" &copy; 2009-%1 ").arg(COPYRIGHT_YEAR) + tr("The Bitcoin Core developers") + QString("<br>") + tr("Copyright") + QString(" &copy; 2013-%1 ").arg(COPYRIGHT_YEAR) + tr("The Experiencecoin developers"));
}
    ...
    ui(new Ui::HelpMessageDialog)
{
    ...
    header = tr("Experiencecoin Core") + " " + tr("version") + " " +
...
void ShutdownWindow::showShutdownWindow(BitcoinGUI *window)
{
    ...
    layout->addWidget(new QLabel(
        tr("Experiencecoin Core is shutting down...") + "<br /><br />" +
