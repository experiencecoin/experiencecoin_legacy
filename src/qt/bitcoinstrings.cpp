...
QT_TRANSLATE_NOOP("bitcoin-core", "Experiencecoin version"),
...
QT_TRANSLATE_NOOP("bitcoin-core", "Listen for connections on <port> (default: 8933 or testnet: 18933)"),
...
QT_TRANSLATE_NOOP("bitcoin-core", "SSL options: (see the Experiencecoin Wiki for SSL setup instructions)"),
QT_TRANSLATE_NOOP("bitcoin-core", "Select the version of socks proxy to use (4-5, default: 5)"),
QT_TRANSLATE_NOOP("bitcoin-core", "Send command to -server or experiencecoind"),
...
QT_TRANSLATE_NOOP("bitcoin-core", "Wallet needed to be rewritten: restart Experiencecoin to complete"),
