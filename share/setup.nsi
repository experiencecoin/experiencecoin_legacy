...
Section -Main SEC0000
    SetOutPath $INSTDIR
    SetOverwrite on
    File ../release/experiencecoin-qt.exe
...
Section -post SEC0001
    ...
    CreateShortcut "$SMPROGRAMS\$StartMenuGroup\Litecoin.lnk" $INSTDIR\experiencecoin-qt.exe
    ...
    WriteRegStr HKCR "litecoin\DefaultIcon" "" $INSTDIR\experiencecoin-qt.exe
    WriteRegStr HKCR "litecoin\shell\open\command" "" '"$INSTDIR\experiencecoin-qt.exe" "%1"'
SectionEnd
